...
from tensorflow.keras.applications import EfficientNetB0 # Using B0
...
# --- Basic Settings ---
DATA_ROOT = '/home/sagemaker-user/AUT2025/X_ray/DATA/1500_train' # Example path
NUM_CLASSES = 5
...
# Consider adding clipnorm=1.0 to SGD optimizer below if needed.
LEARNING_RATE = 1e-4

# --- Regularization ---
DROPOUT_RATE = 0.3       # Adjust based on overfitting/underfitting (e.g., 0.2-0.5)
WEIGHT_DECAY = 1e-4      # Adjust if needed (e.g., 1e-5, 5e-4)

# --- Callbacks ---
LR_PATIENCE = 10         # Increased patience for LR reduction
LR_FACTOR = 0.2
ES_MONITOR = 'val_loss'
ES_PATIENCE = 25         # Increased patience for early stopping
ES_MODE = 'min'
...
LOG_BASE_DIR = 'logs_keras_simple'
CHECKPOINT_BASE_DIR = 'checkpoints_keras_simple'
...
def build_keras_efficientnet(input_shape, num_classes, dropout_rate=0.2, model_name=""):
    """Builds an EfficientNetB0 model with ALL base layers unfrozen."""
...
best_checkpoint_path = "./checkpoints_keras_simple/EfficientNetB0_full_finetune_best_20250427-004723.weights.h5"
